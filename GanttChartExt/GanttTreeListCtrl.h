...
protected:
	...
	void RemoveDeletedTasks(HTREEITEM hti, const ITaskList14* pTasks);
	...
	BOOL RecalcTreeColumns(int nEditAttribute, BOOL bResize = TRUE);
	...
	static GTLC_COLUMN MapAttribToColumn(int nEditAttrib);
