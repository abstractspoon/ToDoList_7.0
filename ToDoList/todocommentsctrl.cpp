...
BOOL CToDoCommentsCtrl::Paste()
{
	...
	case 0:
		CUrlRichEditCtrl::Paste(); // default
		return TRUE;
...
{
	return GetParent()->SendMessage(WM_TDCM_FAILEDLINK, 0, (LPARAM)szUrl);
}
...
CLIPFORMAT CToDoCommentsCtrl::GetAcceptableClipFormat(LPDATAOBJECT lpDataOb, CLIPFORMAT format) 
{ 
