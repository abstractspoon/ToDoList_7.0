...
public:
	...
	bool AddCustomAttribute(LPCTSTR szID, LPCTSTR szLabel);
...
protected:
	...
	bool SetTaskDate(HTASKITEM hTask, const CString& sDateItem, const COleDateTime& tVal, BOOL bIncTime, const CString& sDateStringItem = EMPTY_STR);
