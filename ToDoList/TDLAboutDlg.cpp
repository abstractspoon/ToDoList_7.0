	...
	: CDialog(IDD_ABOUT_DIALOG, pParent)
{
	...
	//}}AFX_DATA_INIT
	m_sTitle.Format(_T("<b>%s</b> (c) AbstractSpoon 2003-15"), sAppTitle);
	m_sLicense.Format(IDS_LICENSE, _T("\"https://github.com/abstractspoon/ToDoList_Wiki/wiki/Free-Open-Source-Software\""));
