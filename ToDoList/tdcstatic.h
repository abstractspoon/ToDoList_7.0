...
static const TCHAR CLOCKCHAR[] = { 0xb9, 0 };
static const TCHAR LINKCHAR[]  = { 0x24, 0 };
static const TCHAR FLAGCHAR[]  = { 0x4f, 0 };
static const TCHAR BELLCHAR[]  = { 0x25, 0 };
...
{
	{ TDCC_POSITION,	IDS_TDC_COLUMN_POS,			IDS_TDLBC_POS,			DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_ID,			IDS_TDC_COLUMN_ID,			IDS_TDLBC_ID,			DT_RIGHT, NULL, FALSE, TRUE },								
	{ TDCC_PARENTID,	IDS_TDC_COLUMN_PARENTID,	IDS_TDLBC_PARENTID,		DT_RIGHT, NULL, FALSE, TRUE },								
	{ TDCC_PRIORITY,	IDS_TDC_COLUMN_PRIORITY,	IDS_TDLBC_PRIORITY,		DT_CENTER, NULL, FALSE, FALSE },
	{ TDCC_RISK,		0x4d,						IDS_TDLBC_RISK,			DT_CENTER, _T("Wingdings"), TRUE, TRUE },
	{ TDCC_PERCENT,		IDS_TDC_COLUMN_PERCENT,		IDS_TDLBC_PERCENT,		DT_CENTER, NULL, FALSE, FALSE },
	{ TDCC_TIMEEST,		IDS_TDC_COLUMN_TIMEEST,		IDS_TDLBC_TIMEEST,		DT_RIGHT, NULL, FALSE, TRUE },
	{ TDCC_TIMESPENT,	IDS_TDC_COLUMN_TIMESPENT,	IDS_TDLBC_TIMESPENT,	DT_RIGHT, NULL, FALSE, TRUE },
	{ TDCC_TRACKTIME,	0xb9,						IDS_TDLBC_TRACKTIME,	DT_CENTER, _T("Wingdings"), TRUE, TRUE },
	{ TDCC_CREATIONDATE, IDS_TDC_COLUMN_CREATEDATE, IDS_TDLBC_CREATEDATE,	DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_CREATEDBY,	IDS_TDC_COLUMN_CREATEDBY,	IDS_TDLBC_CREATEDBY,	DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_LASTMOD,		IDS_TDC_COLUMN_MODIFYDATE,	IDS_TDLBC_MODIFYDATE,	DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_RECENTEDIT,	IDS_TDC_COLUMN_RECENTEDIT,	IDS_TDLBC_RECENTEDIT,	DT_CENTER, NULL, FALSE, TRUE },
	{ TDCC_STARTDATE,	IDS_TDC_COLUMN_STARTDATE,	IDS_TDLBC_STARTDATE,	DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_DUEDATE,		IDS_TDC_COLUMN_DUEDATE,		IDS_TDLBC_DUEDATE,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_REMAINING,	0x36,						IDS_TDLBC_REMAINING,	DT_LEFT, _T("Wingdings"), TRUE, TRUE },
	{ TDCC_DONEDATE,	IDS_TDC_COLUMN_DONEDATE,	IDS_TDLBC_DONEDATE,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_RECURRENCE,	IDS_TDC_COLUMN_RECURRENCE,	IDS_TDLBC_RECURRENCE,	DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_ALLOCTO,		IDS_TDC_COLUMN_ALLOCTO,		IDS_TDLBC_ALLOCTO,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_ALLOCBY,		IDS_TDC_COLUMN_ALLOCBY,		IDS_TDLBC_ALLOCBY,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_STATUS,		IDS_TDC_COLUMN_STATUS,		IDS_TDLBC_STATUS,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_CATEGORY,	IDS_TDC_COLUMN_CATEGORY,	IDS_TDLBC_CATEGORY,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_TAGS,		IDS_TDC_COLUMN_TAGS,		IDS_TDLBC_TAGS,			DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_EXTERNALID,	IDS_TDC_COLUMN_EXTID,		IDS_TDLBC_EXTERNALID,	DT_RIGHT, NULL, FALSE, TRUE },
	{ TDCC_COST,		IDS_TDC_COLUMN_COST,		IDS_TDLBC_COST,			DT_RIGHT, NULL, FALSE, TRUE },
	{ TDCC_VERSION,		IDS_TDC_COLUMN_VERSION,		IDS_TDLBC_VERSION,		DT_LEFT, NULL, FALSE, TRUE },
	{ TDCC_DEPENDENCY,	0xc3,						IDS_TDLBC_DEPENDS,		DT_CENTER, _T("Wingdings"), TRUE, TRUE },
	{ TDCC_FILEREF,		0x3c,						IDS_TDLBC_FILEREF,		DT_CENTER, _T("Wingdings"), TRUE, TRUE },
	{ TDCC_FLAG,		0x4f,						IDS_TDLBC_FLAG,			DT_CENTER, _T("Wingdings"), TRUE, FALSE },
	{ TDCC_REMINDER,	0x25,						IDS_TDLBC_REMINDER,		DT_CENTER, _T("Wingdings"), TRUE, FALSE },
	{ TDCC_ICON,		0x4a,						IDS_TDLBC_ICON,			DT_CENTER, _T("Wingdings"), TRUE, FALSE },
	{ TDCC_DONE,		0x61,						IDS_TDLBC_DONE,			DT_CENTER, _T("Marlett"), TRUE, FALSE },
	{ TDCC_PATH,		IDS_TDC_COLUMN_PATH,		IDS_TDLBC_PATH,			DT_LEFT, NULL, FALSE, FALSE },
	{ TDCC_SUBTASKDONE,	IDS_TDC_COLUMN_SUBTASKDONE,	IDS_TDLBC_SUBTASKDONE,	DT_RIGHT, NULL, FALSE, TRUE },
	
	// special client column
	{ TDCC_CLIENT,		IDS_TDC_COLUMN_TASK,		IDS_TDLBC_NAME,			DT_LEFT, NULL, FALSE, TRUE },
};
