...
public:
	...
	BOOL GetTime(double& dValue, int& nUnits, BOOL& bOffset) const;
	BOOL GetDate(double& dValue, int& nUnits, BOOL& bOffset) const;
...
public:
	...
	BOOL GetStartDate(double& dValue, int& nUnits, BOOL& bOffset) const { return m_dtStartDate.GetDate(dValue, nUnits, bOffset); } 
	BOOL GetStartTime(double& dValue, BOOL& bOffset) const { return m_dStartTime.GetValue(dValue, bOffset); } 
	BOOL GetDueDate(double& dValue, int& nUnits, BOOL& bOffset) const { return m_dtDueDate.GetDate(dValue, nUnits, bOffset); } 
	BOOL GetDueTime(double& dValue, BOOL& bOffset) const { return m_dDueTime.GetValue(dValue, bOffset); }
	BOOL GetDoneDate(double& dValue, int& nUnits, BOOL& bOffset) const { return m_dtDoneDate.GetDate(dValue, nUnits, bOffset); } 
	...
	BOOL GetTimeEst(double& dValue, int& nUnits, BOOL& bOffset) const { return m_dTimeEst.GetTime(dValue, nUnits, bOffset); } 
	BOOL GetTimeSpent(double& dValue, int& nUnits, BOOL& bOffset) const { return m_dTimeSpent.GetTime(dValue, nUnits, bOffset); } 
