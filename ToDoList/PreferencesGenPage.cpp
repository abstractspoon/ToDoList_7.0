...
void CPreferencesGenPage::LoadPreferences(const CPreferences& prefs)
{
	...
	m_bEnableTDLExtension = prefs.GetProfileInt(_T("Preferences"), _T("EnableTDLExtension"), TRUE/*!prefs.UsesIni()*/);
...
void CPreferencesGenPage::OnSelchangeLanguage() 
{
	...
	BOOL bEnable = (!m_cbLanguages.IsDefaultLanguage() && (sLangFile == sCurLangFile));
